...
public class Raindrop implements Steppable
{
    ...
    public void step(SimState state)
    {
        ...
        try {
          landscape.getMooreNeighbors(basin.loc_x, basin.loc_y, 1, Grid2D.TOROIDAL, true, neighbors, null, null);
        }
        catch(Exception e) {
          System.out.println("x: "+basin.loc_x+" y: "+basin.loc_y+" width: "+landscape.width+" height: "+landscape.height);
        }
