...
//                System.out.println(System.getProperty("user.dir"));
            ...
            String fileName = classLoader.getResource("campusworld/data/bldg.shp").getFile();
            URL bldgGeometry = new File(fileName).toURI().toURL();
            ...
            fileName = classLoader.getResource("campusworld/data/roads.shp").getFile();
            URL roadGeometry = new File(fileName).toURI().toURL();
            ...
            fileName = classLoader.getResource("campusworld/data/walk_ways.shp").getFile();
            URL walkWayGeometry = new File(fileName).toURI().toURL();
